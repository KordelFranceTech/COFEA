...
# TODO @kordel.france - build these out and tie these to GCP
def download_neural_net_data(path:str):
    return path


def download_conv_neural_net_data(path:str):
    return path


def download_pso_neural_net_data(path:str):
    return path
