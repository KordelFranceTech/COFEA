...
# ########################################################################################################################
#
# from MaciNet.neural_networks import convolutional_neural_network_tf as cnn_tf
# from MaciNet.neural_networks import neural_network_tf as nn_tf
# from MaciNet.neural_networks import convolutional_neural_network as cnn
# from MaciNet.neural_networks import neural_network as nn
# from MaciNet.neural_networks import pso_neural_network as pso_nn
# from MaciNet.data_processing import download_neural_net_data
# from MaciNet.data_processing import download_conv_neural_net_data
# from MaciNet.data_processing import download_pso_neural_net_data
#
#
...
#     nn_filepath: str = './data/Sheet 1-ThetaDataset_Sensor1_rev2.csv'
...
#     # Replace with database paths for production
#     cnn_filepath: str = './data/ThetaDataset_Sensors12.csv'
...
#     # Replace with database paths for production
#     pso_filepath: str = './data/ThetaDataset_Sensors12.csv'
